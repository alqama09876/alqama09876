...
#### 🔹 QA & Automation  
- Manual Testing | Test Case Design | Defect Tracking | Regression, Smoke & Sanity | UAT Support  
- **Selenium WebDriver (C#, MSTest, NUnit)** | **Playwright (TypeScript)** | Page Object Model  
- Postman | REST API Debugging | JSON & Schema Validation  
- JIRA | Azure DevOps | Jenkins (CI/CD) | Extent & Allure Reporting  

#### 🔹 Languages & Databases  
- **Languages:** C# | TypeScript | Java | SQL | Kotlin  
- **Databases:** Microsoft SQL Server | MySQL | Firebase  

#### 🔹 Development & Tools  
- **Mobile Dev:** Android (Java/Kotlin, Firebase, REST API, SQLite, Room DB)  
- **Tools:** Git | GitHub | Visual Studio | VS Code | SSMS | Android Studio  
- **Practices:** SDLC | STLC | Agile/Scrum | OOP | Clean Code | Test Pyramid  
...
### 🌐 Connect with Me  
<p align="left">
<a href="https://www.linkedin.com/in/alqama-mujahid-qureshi-6b651b26b/" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="alqama-mujahid-qureshi" height="30" width="40" /></a>
